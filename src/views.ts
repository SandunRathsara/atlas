...
import type { RefreshState, Repository, Session, SessionFilter, SessionState, Spec } from "./persistence.ts";
...
type ActivePage = "repositories" | "new-repository" | "specs" | "spec" | "sessions";
